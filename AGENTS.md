...
# E2E tests (real ArtSoft Consult website, SOLR conditional)
npm run test:e2e
...
- `tests/validate-artsoft-consult-jobs.js` — CI fast validator (HEAD only); thin wrapper over src/job-validator.js + solr.js
