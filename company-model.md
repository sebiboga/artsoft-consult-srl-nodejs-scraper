...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "ArtSoft Consult") |
| group        | string   | Parent company group (e.g. "ART SOFT CONSULT SRL") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/artsoft-consult-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)